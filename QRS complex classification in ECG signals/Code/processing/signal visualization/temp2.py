...
data_dir_good= 'X/polymorph/1-data'
filename = 'I01'
...
plt.savefig(os.path.join(data_dir, f"{filename}_sliced-on_{temp}" + '_plot.png'))
plt.savefig(os.path.join(data_dir_good, f"{filename}_sliced-on_{temp}" + '_plot.png'))